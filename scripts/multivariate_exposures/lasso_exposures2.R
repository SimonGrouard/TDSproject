...
pdf('/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lasso_model.pdf')
plot(lasso_model)
dev.off()

## Regularization Path
lasso_path = glmnet(x = X, y = Y, penalty.factor = c(rep(1, 39), 0, rep(1, 22), 0, rep(1, 106)))
pdf('/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lasso_path.pdf')
plot(lasso_path)
dev.off()
...
saveRDS(beta_lasso_lambda.1se, "/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/beta_lasso.1se.rds")
selected_lasso_lambda.1se = names(beta_lasso_lambda.1se)[which(beta_lasso_lambda.1se != 0)]
saveRDS(selected_lasso_lambda.1se, "/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/selected_beta_lasso.1se.rds")
...
pdf('/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lambda.1se_lasso_selected_exposures.pdf')
...
saveRDS(beta_lasso_lambda.min, "/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/beta_lasso.min.rds")
selected_lasso_lambda.min = names(beta_lasso_lambda.min)[which(beta_lasso_lambda.min != 0)]
saveRDS(selected_lasso_lambda.min, "/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/selected_beta_lasso.min.rds")
print(paste0(length(selected_lasso_lambda.min), " exposures are selected when using lambda.min"))

pdf('/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lambda.min_lasso_selected_exposures.pdf')
...
saveRDS(lasso_model, "/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lasso_model.rds")
...
saveRDS(lasso.prop, '/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lasso.1se_Prop.rds')

pdf('/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lambda.1se_PropPlot.pdf')
...
lasso.prop=sort(lasso.prop, decreasing = TRUE)
saveRDS(lasso.prop, '/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lasso.min_Prop.rds')

pdf('/rds/general/project/hda_21-22/live/TDS/Group_6/Results/Results_multivariate_exposures/Lasso2/lambda.min_PropPlot.pdf')
plot(lasso.prop[lasso.prop>0.2], type = 'h', col='navy', lwd=3, xaxt='n', 
     xlab='', ylab=expression(beta), ylim=c(0,1.2), las=1)
text(lasso.prop[lasso.prop>0.2]+0.07, labels = names(lasso.prop[lasso.prop>0.2]), 
