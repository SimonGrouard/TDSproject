...
dir.create("/rds/general/project/hda_21-22/live/TDS/Group_6/extraction_and_recording/parameters", showWarnings = FALSE)
...
dict <- fread("/rds/general/project/hda_21-22/live/TDS/Group_6/extraction_and_recording/docs/Data_Dictionary_Showcase.csv", data.table = FALSE) # Data dictionary from UKBB: https://biobank.ctsu.ox.ac.uk/crystal/exinfo.cgi?src=accessing_data_guide
...
saveWorkbook(wb, "/rds/general/project/hda_21-22/live/TDS/Group_6/extraction_and_recording/parameters/selection_group6.xlsx", overwrite = TRUE)
